...
<div class="am-g">
    <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
        ...
        @endif
        <form method="post" class="am-form" action="{{ route('password.update') }}">
            {{csrf_field()}}
            ...
            <div class="am-cf">
                <button type="submit" name="" class="am-btn am-btn-secondary am-fr ">修改密码</button>
            </div>
        </form>
        <br>
    </div>
