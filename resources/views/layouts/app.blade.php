    ...
    <div class="am-container">
        ...
        <div class="am-collapse am-topbar-collapse" id="collapse-head">
            <ul class="am-nav am-nav-pills am-topbar-nav">
                <li><a href="{{ route('issues.index') }}">已发布的话题</a></li>
                    ...
                    <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
                        <li class="am-dropdown" data-am-dropdown>
                            <a class="am-btn-secondary am-dropdown-toggle" data-am-dropdown-toggle href="javascript:;">
                                <span class="am-icon-user"></span> {{Auth::user()->username}}
                                <span class="am-icon-caret-down"></span>
                            </a>
                            <ul class="am-dropdown-content">
                                <li>
                                    <a href="{{ route('users.edit', Auth::user()->id) }}">
                                        <span class=""></span> 编辑资料
                                    </a>
...
<footer class="footer">
    <p class="am-padding-left">Copyright © 2018. Made With <i class="am-icon am-icon-heart"></i> By Desmond. All Rights Reserved.</p>
</footer>
